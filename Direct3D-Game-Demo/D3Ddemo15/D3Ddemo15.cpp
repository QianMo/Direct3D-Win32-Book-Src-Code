...
#define WINDOW_TITLE	_T("【致我们永不熄灭的游戏开发梦想】 虚实结合的光影 : 模板技术  示例程序") //为窗口标题定义的宏
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpCmdLine, int nShowCmd)
{
	...
	PlaySound(L"仙剑·战斗3.wav", NULL, SND_FILENAME | SND_ASYNC|SND_LOOP);   //循环播放背景音乐
...
void Direct3D_Render(HWND hwnd)
{
	...
	// 9.恢复渲染状态
 	...
 	g_pd3dDevice->SetRenderState(D3DRS_CULLMODE,         D3DCULL_CCW);
			...
			swprintf_s(strInfo,-1, L"模型坐标: (%.2f, %.2f, %.2f)", matHero._41, matHero._42, matHero._43);

...
#define WINDOW_TITLE	_T("【致我们永不熄灭的游戏开发梦想】  网格模型和X文件使用面面观 示例程序") //为窗口标题定义的宏
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance,LPSTR lpCmdLine, int nShowCmd)
{
	...
	PlaySound(L"仙剑·王蓬絮.wav", NULL, SND_FILENAME | SND_ASYNC|SND_LOOP); //循环播放背景音乐 
